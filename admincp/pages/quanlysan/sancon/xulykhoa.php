...
if (isset($_POST['id'])) {
    ...
    // Truy vấn để cập nhật trạng thái của sân con thành 'khonghoatdong'
    $sql = "UPDATE Sancon SET Trangthai = 'khonghoatdong' WHERE id = ?";
    ...
    if ($stmt->execute()) {
        $_SESSION['success-message'] = "Đã tạm khóa sân.";
    } else {
